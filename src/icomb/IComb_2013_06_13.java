...
//
///**
// * Esta � classe principal do programa e est� implementada na forma
// * <b>superapplet</b>, ou seja, funciona tanto como applet quanto
// * como uma aplica��o independente. 
...
//  String dica="Um baralho de 32 cartas corresponde a um baralho comum sem as cartas cujos valores s�o menores do que Sete. Portanto, um baralho de 32 cartas 8 cartas de cada naipe (7,8,9,10,Valete, Dama, Rei e �s)";
//  String enumGabarito ="Com um baralho de 32 cartas, quantas m�os de 5 cartas � poss�vel formar com exatamente 2 cartas de Copas e exatamente duas cartas de Espadas?";
...
//    System.out.println(" .: iComb : Combinat�ria Interativa na Internet ("+versao+") :.\n    http://www.matematica.br/icomb");
//
//    try {
//
...
//       ObjectManager.setMachine.loadUniverso(applet.montaFace); // icomb.objects.Universo: s� aqui define ''src/icomb/machine/SetMachine.java!universo'
//       }
//    appletFrame.pack();
//
//    } catch (Exception e) {
...
//
//
//    // O frame dever� aparecer na tela antes que o m�todo init() do applet seja chamado
...
//
//       // Se resposta foi enviada, mostrar resultado ao inv�s do todo 
...
//    //? ObjectManager.setMachine.loadUniverso(montaFace); // icomb.objects.Universo: s� aqui define ''src/icomb/machine/SetMachine.java!universo'
//
...
//
//  /**
//   * Resultado da Avalia��o do Exerc�cio 
//   * 
